...
struct SendRequestPopupView: View {
        ...
        return VStack {
            ...
            ZStack {
                VStack {
                    ...
                    Button {
                        Task {
                            conView.sendConnectionRequest(sender: cUser!, reciever: selectedUser!, passphrase: inptData, isConnected: "pending")
                            inptData=""
                            isShowing = false
                        }
...
#Preview {
    SendRequestPopupView(isShowing: .constant(false), heading: .constant(""))
}
